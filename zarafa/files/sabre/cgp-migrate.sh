...
# Michael Kromer <m.kromer@zarafa.com>
# Mark de Bruijn
#
...
for source_account in ${SOURCE_USER} ${SOURCE_SEC_USER} ; do
   ...
   while read -r MBOXFILE; do
      ...
      if [[ "$contact_count" -gt 0 ]]; then
         ...
         # <td><a href="/zarafa-sabre/addressbooks/st000003/Kontakte_in_der_Inbox/import-Kontakte_in_der_Inbox-555188919.6.herbie%40example.org.vcf">import-Kontakte_in_der_Inbox-555188919.6.herbie@example.org.vcf</a></td>
